    ...
    def print_exl_report(self):
        if xlwt:
            ...
            if self.display_sum:
                ...
                worksheet.write_merge(0, 1, 2, 20, "Inventory Valuation Report", style=style_title)
                ...
                worksheet.write(8, 6, 'Opening Stock', style_table_header)
                worksheet.write(8, 7, 'Opening Value', style_table_header)
                worksheet.write(8, 8, 'Internal', style_table_header)
                worksheet.write(8, 9, 'Internal Value', style_table_header)
                worksheet.write(8, 10, 'Received Qty', style_table_header)
                worksheet.write(8, 11, 'Received Value', style_table_header)
                worksheet.write(8, 12, 'Issued Qty', style_table_header)
                worksheet.write(8, 13, 'Issued Value', style_table_header)
                worksheet.write(8, 14, 'Manufacturing Qty', style_table_header)
                worksheet.write(8, 15, 'Manufacturing Value', style_table_header)
                worksheet.write(8, 16, 'Consumed components Qty', style_table_header)
                ...
                worksheet.write(8, 22, 'Total MO', style_table_header)
                worksheet.write(8, 23, 'Total Consumed Components', style_table_header)
                worksheet.write(8, 24, 'Adjustment', style_table_header)
                worksheet.write(8, 25, 'Adjustment Value', style_table_header)
                worksheet.write(8, 26, 'Closing Stock', style_table_header)
                ...
                for each in get_line:
                    ...
                    worksheet.write(prod_row, prod_col + 10,(each['incoming']), style)
                    worksheet.write(prod_row, prod_col + 11, (each['incoming'] * each['cost_price']), style)
                    worksheet.write(prod_row, prod_col + 12, (each['sale_value']), style)
                    worksheet.write(prod_row, prod_col + 13, (each['sale_value'] * each['cost_price']), style)
                    worksheet.write(prod_row, prod_col + 14, (each['manufacturing_value']), style)
                    worksheet.write(prod_row, prod_col + 15,(each['manufacturing_value'] * each['cost_price']), style)

                    worksheet.write(prod_row, prod_col + 16, (each['consumed_components']), style)
                    ...
                    worksheet.write(prod_row, prod_col + 22, (each['manufacturing_value']-each['unbuild_main']), style)
                    worksheet.write(prod_row, prod_col + 23, (each['consumed_components'] - each['unbuild_components']), style)


                    worksheet.write(prod_row, prod_col + 24, (each['outgoing']), style)
                    worksheet.write(prod_row, prod_col + 25, (each['outgoing'] * each['cost_price']), style)
                    worksheet.write(prod_row, prod_col + 26,(each['net_on_hand']), style)
