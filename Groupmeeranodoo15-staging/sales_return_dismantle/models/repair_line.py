...
class RepairComponents(models.Model):
    ...
    dismantle_process_id = fields.Many2one('dismantle.process', string='Sales Return QC Reference', required=True, ondelete='cascade',
                                     index=True, copy=False)
    company_id = fields.Many2one(related='dismantle_process_id.company_id', string='Company', store=True, index=True)
    ...
    user_id = fields.Many2one(related='dismantle_process_id.user_id', store=True, string='User')
