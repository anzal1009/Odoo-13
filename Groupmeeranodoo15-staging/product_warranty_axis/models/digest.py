...
class Digest(models.Model):
    ...
    def _compute_kpi_helpdesk_tickets_closed_value(self):
        if not self.env.user.has_group('product_warranty_axis.group_helpdesk_user'):
    ...
    def _compute_kpis_actions(self, company, user):
        ...
        res['kpi_helpdesk_tickets_closed'] = 'product_warranty_axis.helpdesk_team_dashboard_action_main&menu_id=%s' % self.env.ref('helpdesk.menu_helpdesk_root').id
        return res
