...
class WebsiteHelpdesk(http.Controller):
    ...
    @http.route(['/helpdesk/rating', '/helpdesk/rating/<model("helpdesk.team"):team>'], type='http', auth="public", website=True, sitemap=True)
    def page(self, team=False, **kw):
        ...
        if user.has_group('product_warranty_axis.group_heldpesk_manager'):
        ...
        return request.render('product_warranty_axis.team_rating_page', {'page_name': 'rating', 'teams': team_values})
