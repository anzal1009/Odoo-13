...
class ResConfigSettings(models.TransientModel):
    ...
    je_negative_balance_cash_bank = fields.Boolean(string='Enable -ve Balance checking in JE(Cash and Bank)',
                                                   default=True)
    ...
    def get_values(self):
        ...
        je_negative_balance_cash_bank = ICPSudo.get_param('bi_sale_purchase_discount_with_tax.tax_discount_policy')
    ...
    def set_values(self):
        ...
        for rec in self:
            ...
            ICPSudo.set_param('restrict_je_cash_bank.je_negative_balance_cash_bank', rec.je_negative_balance_cash_bank)
...
class AccountMove(models.Model):
    ...
    def action_post(self):
        je_negative_balance_cash_bank = self.env["ir.config_parameter"].sudo().get_param(
            "restrict_je_cash_bank.je_negative_balance_cash_bank")
